...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "HealthCheck.serviceName":
		if e.complexity.HealthCheck.ServiceName == nil {
			break
		}

		return e.complexity.HealthCheck.ServiceName(childComplexity), true
...
var sources = []*ast.Source{
	{Name: "pkg/delivery/graphql/schema/query.graphql", Input: `type Query {
    healthCheck: HealthCheck!
}`, BuiltIn: false},
	{Name: "pkg/delivery/graphql/schema/type/health_check.graphql", Input: `type HealthCheck {
    serviceName: String!
    uptime: String!
}`, BuiltIn: false},
}
...
func (ec *executionContext) _HealthCheck_serviceName(ctx context.Context, field graphql.CollectedField, obj *model.HealthCheck) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
...
func (ec *executionContext) _Query_healthCheck(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNHealthCheck2ᚖgitlabᚗcomᚋterascodeᚋterasworkᚋbackendᚋgoᚑboilerplateᚋpkgᚋdeliveryᚋgraphqlᚋmodelᚐHealthCheck(ctx, field.Selections, res)
}
...
func (ec *executionContext) _HealthCheck(ctx context.Context, sel ast.SelectionSet, obj *model.HealthCheck) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "serviceName":
			out.Values[i] = ec._HealthCheck_serviceName(ctx, field, obj)
...
func (ec *executionContext) marshalNHealthCheck2gitlabᚗcomᚋterascodeᚋterasworkᚋbackendᚋgoᚑboilerplateᚋpkgᚋdeliveryᚋgraphqlᚋmodelᚐHealthCheck(ctx context.Context, sel ast.SelectionSet, v model.HealthCheck) graphql.Marshaler {
	return ec._HealthCheck(ctx, sel, &v)
}

func (ec *executionContext) marshalNHealthCheck2ᚖgitlabᚗcomᚋterascodeᚋterasworkᚋbackendᚋgoᚑboilerplateᚋpkgᚋdeliveryᚋgraphqlᚋmodelᚐHealthCheck(ctx context.Context, sel ast.SelectionSet, v *model.HealthCheck) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
